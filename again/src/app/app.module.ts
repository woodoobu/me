...
import { PodcastComponent } from 'src/pages/podcast/podcast.component';
...
import { Start2Component } from 'src/pages/start2/start2.component';
import { Start3Component } from 'src/pages/start3/start3.component';
